...
regional_repo$regional_im %>%
  summarise(
    sm_radio = sum(sm_info_radio, na.rm = TRUE),
    sm_tv = sum(sm_info_tv, na.rm = TRUE),
    sm_hworker = sum(sm_info_hworker, na.rm = TRUE),
    sm_mosque = sum(sm_info_mosque, na.rm = TRUE),
    sm_mourchidate = sum(sm_info_mourchidate, na.rm = TRUE)
  )
