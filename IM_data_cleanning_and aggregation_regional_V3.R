# ============================================================
# Batch regional IM cleaning and aggregation pipeline
# Generic version for AFRO countries
# ============================================================
...
process_im_file <- function(input_file, output_folder, qc_output_folder, lookup_table) {
  ...
  tibble(
    ...
    max_date = suppressWarnings(max(FE$end_date_IM_end, na.rm = TRUE))
  )
}
...
summary_table <- process_all_im_files(
