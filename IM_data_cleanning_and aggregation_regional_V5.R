...
# - fixes Number_of_HH_visited crash
# - fixes bind_rows type mismatch in regional repository
# ============================================================
...
# typed binder to avoid character/logical conflicts
...
find_similar_column <- function(target_name, df, exact_first = TRUE) {
  ...
  target_norm <- tolower(target_norm)
...
process_im_file <- function(input_file, output_folder, qc_output_folder, lookup_table) {
  ...
  # safe creation of Number_of_HH_visited
